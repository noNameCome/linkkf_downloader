...
class LinkKFGUI:
    ...
    def setup_ui(self) -> None:
        ...
        ttk.Label(
            instruction_frame,
            text="▶ 형식: https://kr.linkkf.net/player/v[번호]-sub-[번호]/",
...
https://kr.linkkf.net/player/v00000-sub-1/
https://kr.linkkf.net/player/v00000-sub-2/
...
# 사이버 다운로드 준비 완료..."""
    ...
    def validate_urls(self, urls: List[str]) -> List[str]:
        ...
        valid_urls = []
        pattern = r'https://kr\.linkkf\.net/player/v\d+-sub-\d+/?'
